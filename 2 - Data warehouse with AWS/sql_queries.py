...
# For reference, DATE_PART() and EXTRACT() functions can be used interchangeably here
# DATE_PART(hour, start_time) AS hour,
# Can be re-written using the EXTRACT() function as
# EXTRACT(hour from start_time) AS hour
# AWS documentation and Stackoverflow references:
...
# For "weekday" below, function returns a value between 0-6, where 0 = Sunday and 6 = Saturday
time_table_insert = ("""
...
# Return total record count of the Staging Events table
count_staging_events = ("""
    SELECT COUNT(*) FROM staging_events
""")

# Return total record count of the Staging Songs table
count_staging_songs = ("""
    SELECT COUNT(*) FROM staging_songs 
""")

# Return top 10 record counts of total songs released across all years
# but not more than 1000 in a given year
year_song_count = ("""
...
insert_table_info = ['User table', 'Song table', 'Artist table', 'Time table', 'Song play table']
